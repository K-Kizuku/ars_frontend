...
export const create = createVElement(
  "body",
  { class: "body", style: "background: #D9D9D9" },
  footer,
  sidebar,
  createVElement(
    "main",
    { class: "main", style: " height: 110px" },
    createVElement(
      "div",
      {},
      createVElement("h1", {}, "welcome ASFA!"),
      createVElement("h2", {}, "新規会員登録")
    ),
    createVElement(
      "div",
      {},
    ...
    createVElement(
      "div",
      { class: "fix", display: "flex", style: "margin: 0 0 0 20%" },
      createVElement(
        "form",
        { class: "userdata" },
        createVElement("input", {
        ...
        createVElement("input", {
          ...
          value: "Enter",
          style:
            "line-height:3rem; width:50%; margin:1rem 6rem 0rem 4rem; background-Color: #FDFF88 ",
        })
      )
    )
  )
